...
"""
Add default config for TSTrans.
"""
cfg = edict()
...
# MODEL.MOTIONAL_CORRECTION
cfg.MODEL.MOTION = edict()
cfg.MODEL.MOTION.BETA = 64
cfg.MODEL.MOTION.GAMA = 5
...
cfg.DATA.TRAIN.DATASETS_NAME = ["SV-SV248S-train"]  # ["SV-SatSOT-train"] or ["SV-VISO-train"]
cfg.DATA.TRAIN.DATASETS_RATIO = [1, 1]
cfg.DATA.TRAIN.SAMPLE_PER_EPOCH = 60000
# DATA.VAL
cfg.DATA.VAL = edict()
cfg.DATA.VAL.DATASETS_NAME = ["SV-SV248S-val"]  # ["SV-SatSOT-val"] or ["SV-VISO-val"]
...
cfg.DATA.TEMPLATE.L = 3
cfg.DATA.TEMPLATE.CONFIDENCE = 0.5
